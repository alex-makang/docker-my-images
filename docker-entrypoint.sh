...
dl_and_move_plugin() {
#This functiopon will go to wordpress's plugin site and look for the download URL for the latest version of plugin.it will download and then extract it to the plugin folder in our wordpress installation
	name="$1";
